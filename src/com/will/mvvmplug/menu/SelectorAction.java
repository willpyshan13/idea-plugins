...
public class SelectorAction extends AnAction {
    final String title = "SelectorAction";
    ...
    public void actionPerformed(AnActionEvent anActionEvent) {
        ...
        if (EditNameUtil.interruptPathDrawable(selectGroup.getPath())) {
            return;
        }

        SelectorDialog findViewDialog = new SelectorDialog(anActionEvent);
